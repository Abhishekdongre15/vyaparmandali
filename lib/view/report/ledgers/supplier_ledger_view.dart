...
class SupplierLedgerView extends StatefulWidget {
  const SupplierLedgerView({Key? key}) : super(key: key);

  @override
  State<SupplierLedgerView> createState() => _SupplierLedgerViewState();
}

class _SupplierLedgerViewState extends State<SupplierLedgerView> {
  DateTime fdate = DateTime(2022, 11, 17);
  DateTime tdate = DateTime(2022, 11, 17);
  TextEditingController fromAcController = TextEditingController();
  TextEditingController toAcController = TextEditingController();
