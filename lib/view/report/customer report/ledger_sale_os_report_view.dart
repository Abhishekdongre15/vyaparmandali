...
class LedgerSaleOSRepostView extends StatefulWidget {
  const LedgerSaleOSRepostView({Key? key}) : super(key: key);

  @override
  State<LedgerSaleOSRepostView> createState() => _LedgerSaleOSRepostViewState();
}

class _LedgerSaleOSRepostViewState extends State<LedgerSaleOSRepostView> {
