...
class APMCDailyReportView extends StatefulWidget {
  const APMCDailyReportView({Key? key}) : super(key: key);

  @override
  State<APMCDailyReportView> createState() => _APMCDailyReportViewState();
}

class _APMCDailyReportViewState extends State<APMCDailyReportView> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              dottedRow(),
              reUseContainer("Daily TurnOver Register", height),
            ],
          ),
        ),
      ),
