...
class UIToolkitSwitch extends StatefulWidget {
  ...
  const UIToolkitSwitch({
    Key? key,
    required this.value,
    required this.onToggle,
    this.activeColor,
    this.inactiveColor = ToolkitColors.white,
    this.activeTextColor = ToolkitColors.white,
    this.inactiveTextColor = ToolkitColors.white,
    this.toggleColor = ToolkitColors.white,
    this.activeToggleColor = ToolkitColors.secondary,
    this.inactiveToggleColor = ToolkitColors.greyDark,
    this.width = 51.0,
    this.height = 31.0,
    this.toggleSize = 27.0,
  ...
  @override
  _UIToolkitSwitchState createState() => _UIToolkitSwitchState();
}

class _UIToolkitSwitchState extends State<UIToolkitSwitch> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(UIToolkitSwitch oldWidget) {
  ...
  Widget build(BuildContext context) {
    Color _toggleColor = ToolkitColors.white;
    Color _switchColor = ToolkitColors.white;
    Border? _switchBorder;
    Border? _toggleBorder;

    if (widget.value) {
      _toggleColor = widget.activeToggleColor ?? widget.toggleColor;
      _switchColor = widget.activeColor ?? ToolkitColors.primary;
      _switchBorder = widget.activeSwitchBorder as Border? ?? widget.switchBorder as Border? ?? Border.all(color: ToolkitColors.primary, width: 1);
      ...
      _switchBorder = widget.inactiveSwitchBorder as Border? ?? widget.switchBorder as Border? ?? Border.all(color: ToolkitColors.greyDark, width: 1);
