...
///
/// {@tool dartpad}
/// This example shows a [CustomLinearProgressIndicator] with a changing value.
///
...
class CustomLinearProgressIndicator extends ProgressIndicator {
  ...
  /// {@template flutter.material.CustomLinearProgressIndicator.trackColor}
  /// Color of the track being filled by the linear indicator.
  ///
  /// If [CustomLinearProgressIndicator.backgroundColor] is null then the
  ...
  /// {@template flutter.material.CustomLinearProgressIndicator.minHeight}
  /// The minimum height of the line used to draw the linear indicator.
  ///
  /// If [CustomLinearProgressIndicator.minHeight] is null then it will use the
  ...
  @override
  State<CustomLinearProgressIndicator> createState() => _LinearProgressIndicatorState();
}

class _LinearProgressIndicatorState extends State<CustomLinearProgressIndicator> with SingleTickerProviderStateMixin {
...
class _CircularProgressIndicatorPainter extends CustomPainter {
  _CircularProgressIndicatorPainter({
    ...
    required this.strokeWidth,
        ...
        arcSweep = value != null ? value.clamp(0.0, 1.0) * _sweep : math.max(headValue * 3 / 2 * math.pi - tailValue * 3 / 2 * math.pi, _epsilon);
  ...
  bool shouldRepaint(_CircularProgressIndicatorPainter oldPainter) {
    return oldPainter.backgroundColor != backgroundColor || oldPainter.valueColor != valueColor || oldPainter.value != value || oldPainter.headValue != headValue || oldPainter.tailValue != tailValue || oldPainter.offsetValue != offsetValue || oldPainter.rotationValue != rotationValue || oldPainter.strokeWidth != strokeWidth;
  }
}
...
///
/// {@tool dartpad}
/// This example shows a [CustomCircularProgressIndicator] with a changing value.
///
...
class CustomCircularProgressIndicator extends ProgressIndicator {
  ...
  /// [CupertinoActivityIndicator] in iOS and [CustomCircularProgressIndicator] in
  ...
  /// {@template flutter.material.CustomCircularProgressIndicator.trackColor}
  ...
  @override
  State<CustomCircularProgressIndicator> createState() => _CircularProgressIndicatorState();
}

class _CircularProgressIndicatorState extends State<CustomCircularProgressIndicator> with SingleTickerProviderStateMixin {
...
///  * [RefreshIndicator], which automatically displays a [CustomCircularProgressIndicator]
///    when the underlying vertical scrollable is overscrolled.
class RefreshProgressIndicator extends CustomCircularProgressIndicator {
  ...
  const RefreshProgressIndicator({
    ...
    Color? color,
    Animation<Color?>? valueColor,
    double strokeWidth = defaultStrokeWidth, // Different default than CustomCircularProgressIndicator.
    String? semanticsLabel,
    String? semanticsValue,
  }) : super(
          key: key,
  ...
  @override
  State<CustomCircularProgressIndicator> createState() => _RefreshProgressIndicatorState();
}
...
class _RefreshProgressIndicatorState extends _CircularProgressIndicatorState {
  ...
  Widget _buildMaterialIndicator(BuildContext context, double headValue, double tailValue, double offsetValue, double rotationValue) {
    ...
    final Color backgroundColor = widget.backgroundColor ?? ProgressIndicatorTheme.of(context).refreshBackgroundColor ?? Theme.of(context).canvasColor;
