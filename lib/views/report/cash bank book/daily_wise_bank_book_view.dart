...
class DailyWiseBankBookView extends StatefulWidget {
  const DailyWiseBankBookView({Key? key}) : super(key: key);

  @override
  State<DailyWiseBankBookView> createState() => _DailyWiseBankBookViewState();
}

class _DailyWiseBankBookViewState extends State<DailyWiseBankBookView> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(),
              reUseContainer("Account Statement"),
            ],
          ),
        ),
      ),
