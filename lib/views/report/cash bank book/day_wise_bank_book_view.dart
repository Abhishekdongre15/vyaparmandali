...
class DayWiseBankBookView extends StatefulWidget {
  const DayWiseBankBookView({Key? key}) : super(key: key);

  @override
  State<DayWiseBankBookView> createState() => _DayWiseBankBookViewState();
}

class _DayWiseBankBookViewState extends State<DayWiseBankBookView> {
