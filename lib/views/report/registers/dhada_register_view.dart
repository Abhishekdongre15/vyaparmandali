...
class DhadaRegisterView extends StatefulWidget {
  const DhadaRegisterView({Key? key}) : super(key: key);

  @override
  State<DhadaRegisterView> createState() => _DhadaRegisterViewState();
}

class _DhadaRegisterViewState extends State<DhadaRegisterView> {
