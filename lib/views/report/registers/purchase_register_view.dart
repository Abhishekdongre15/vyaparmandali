...
class PurchaseRegisterView extends StatefulWidget {
  const PurchaseRegisterView({Key? key}) : super(key: key);

  @override
  State<PurchaseRegisterView> createState() => _PurchaseRegisterViewState();
}

class _PurchaseRegisterViewState extends State<PurchaseRegisterView> {
          ...
          child: Column(
            ...
            children: [
              ...
              reUseRow(
                  ...
                  height: height),
              dottedRow(),
              reUseContainer("Bank Purchase Register", height),
            ],
          ),
        ),
      ),
