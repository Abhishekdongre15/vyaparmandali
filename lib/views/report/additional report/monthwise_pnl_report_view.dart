...
class MonthWisePLReportView extends StatefulWidget {
  const MonthWisePLReportView({Key? key}) : super(key: key);

  @override
  State<MonthWisePLReportView> createState() => _MonthWisePLReportViewState();
}

class _MonthWisePLReportViewState extends State<MonthWisePLReportView> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              dottedRow(),
              reUseContainer("Monthly Cash loss sheet", height),
            ],
          ),
        ),
      ),
