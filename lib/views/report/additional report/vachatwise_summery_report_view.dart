...
class VachatWiseSummeryReportView extends StatefulWidget {
  const VachatWiseSummeryReportView({Key? key}) : super(key: key);

  @override
  State<VachatWiseSummeryReportView> createState() =>
      _VachatWiseSummeryReportViewState();
}

class _VachatWiseSummeryReportViewState
    extends State<VachatWiseSummeryReportView> {
          ...
          child: Column(
            ...
            children: [
              ...
              reUseRow(
                  ...
                  height: height),
              dottedRow(),
              reUseContainer("Farmer TurnOver Register", height),
            ],
          ),
        ),
      ),
