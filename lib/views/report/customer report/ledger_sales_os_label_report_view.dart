...
class LedgerOSLabelRepostView extends StatefulWidget {
  const LedgerOSLabelRepostView({Key? key}) : super(key: key);

  @override
  State<LedgerOSLabelRepostView> createState() =>
      _LedgerOSLabelRepostViewState();
}

class _LedgerOSLabelRepostViewState extends State<LedgerOSLabelRepostView> {
