...
class PartywiseWiseSalesReportView extends StatefulWidget {
  const PartywiseWiseSalesReportView({Key? key}) : super(key: key);

  @override
  State<PartywiseWiseSalesReportView> createState() =>
      _PartywiseWiseSalesReportViewState();
}

class _PartywiseWiseSalesReportViewState
    extends State<PartywiseWiseSalesReportView> {
  DateTime fdate = DateTime(2022, 11, 17);
  DateTime tdate = DateTime(2022, 11, 17);
  TextEditingController partCodeController = TextEditingController();
