...
class TransportReportView extends StatefulWidget {
  const TransportReportView({Key? key}) : super(key: key);

  @override
  State<TransportReportView> createState() => _TransportReportViewState();
}

class _TransportReportViewState extends State<TransportReportView> {
          ...
          child: Column(
            ...
            children: [
              ...
              reUseRow(
                  ...
                  height: height),
              dottedRow(),
              reUseContainer("Hudekari Register", height),
            ],
          ),
        ),
      ),
