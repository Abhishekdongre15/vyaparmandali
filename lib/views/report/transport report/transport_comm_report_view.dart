...
class TransportCommReportView extends StatefulWidget {
  const TransportCommReportView({Key? key}) : super(key: key);

  @override
  State<TransportCommReportView> createState() =>
      _TransportCommReportViewState();
}

class _TransportCommReportViewState extends State<TransportCommReportView> {
  DateTime fdate = DateTime(2022, 11, 17);
  DateTime tdate = DateTime(2022, 11, 17);
  TextEditingController dowryController = TextEditingController();
          ...
          child: Column(
            ...
            children: [
              ...
              reUseRow(
                  ...
                  height: height),
              dottedRow(),
              reUseContainer("Hudekari Commission Register", height),
            ],
          ),
        ),
      ),
