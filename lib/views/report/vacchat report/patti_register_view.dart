...
class PattiRegisterView extends StatefulWidget {
  const PattiRegisterView({Key? key}) : super(key: key);

  @override
  State<PattiRegisterView> createState() => _PattiRegisterViewState();
}

class _PattiRegisterViewState extends State<PattiRegisterView> {
          ...
          child: Column(
            ...
            children: [
              ...
              reUseRow(
                  ...
                  height: height),
              dottedRow(),
              reUseContainer("Farmers Bar Register", height),
            ],
          ),
        ),
      ),
